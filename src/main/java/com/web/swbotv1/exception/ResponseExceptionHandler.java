...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler { //Sirve para manejar las excepciones
    ...
    public ResponseEntity<CustomErrorResponse> handleBussinessRuleException(BussinessRuleException ex, WebRequest request) {
